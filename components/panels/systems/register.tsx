...
const SystemSchema = z.object({
  ...
  check_interval: z.number().refine((n) => Number.isInteger(n) && n > 0, {
    message:
      "Intervalo de verificação deve ser um número inteiro positivo (segundos)",
  }),
});
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setNewSystemForm({ ...newSystemForm, name: e.target.value })
            }
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setNewSystemForm({ ...newSystemForm, target: e.target.value })
            }
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setNewSystemForm({ ...newSystemForm, status: value })
            }
          >
            <SelectTrigger className="bg-background border-border text-foreground focus:ring-primary focus:border-primary transition-colors">
