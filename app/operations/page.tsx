...
export default function OperationsPage() {
  ...
  const operations = [
    ...
    },
    {
      ...
      objectives: ["Penetrar rede", "Coletar evidências", "Identificar jogadores-chave"],
    },
    {
      id: "OP-SIERRA-003",
    ...
    },
    {
      ...
      objectives: ["Proteger ponto de extração", "Neutralizar ameaças", "Extrair ativo"],
    },
    {
      id: "OP-BRAVO-005",
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-wider">CENTRO DE OPERAÇÕES</h1>
          <p className="text-sm text-neutral-400">Planejamento de missões e supervisão de execução</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-neutral-900 border-neutral-700">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-neutral-400 tracking-wider">COMPLETADAS</p>
