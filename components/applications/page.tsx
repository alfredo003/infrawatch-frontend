...
export default function ApplicationsPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-neutral-800 dark:text-neutral-200">Monitoramento de Aplicações</h1>
        <p className="text-sm text-neutral-600 dark:text-neutral-400">Estado das aplicações e serviços corporativos</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-700">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-neutral-600 dark:text-neutral-400">APLICAÇÕES ATIVAS</p>
        ...
        <Card className="bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-700">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-neutral-600 dark:text-neutral-400">UTILIZADORES ATIVOS</p>
        ...
        <Card className="bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-700">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-neutral-600 dark:text-neutral-400">SLA MÉDIO</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {applications.map((app, index) => (
          <Card key={index} className="bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-700">
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                ...
                <Badge className={getStatusColor(app.status)}>
                  {app.status === "online" ? "Online" : app.status === "warning" ? "Aviso" : "Offline"}
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div className="text-center">
                  <p className="text-lg font-bold text-neutral-800 dark:text-neutral-200">{app.uptime}%</p>
                  <p className="text-xs text-neutral-500">Uptime</p>
                </div>
                <div className="text-center">
                  <p className="text-lg font-bold text-neutral-800 dark:text-neutral-200">{app.responseTime}ms</p>
                  <p className="text-xs text-neutral-500">Resposta</p>
                </div>
                <div className="text-center">
                  <p className="text-lg font-bold text-neutral-800 dark:text-neutral-200">{app.users}</p>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-neutral-600 dark:text-neutral-400">Disponibilidade</span>
                  <span className="text-neutral-800 dark:text-neutral-200 font-mono">{app.uptime}%</span>
                </div>
          ...
          <div className="h-64 relative">
            ...
            <div className="absolute top-4 right-4 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-neutral-600 dark:text-neutral-400">Tempo de Resposta</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-1 bg-green-600 rounded"></div>
                <span className="text-xs text-neutral-600 dark:text-neutral-400">Throughput</span>
              </div>
            </div>
          </div>
        </CardContent>
