...
import { CONNECTION_TYPES, INTEGRATION_TYPES, STATUS_OPTIONS } from "./register";
 ...
 export default function  ListIntegrations({integrations,loading,onSystemReload}:ListProps)
    {
